...
@Service
public class TMDBMovieService implements MovieService, InitializingBean {
        ...
        public RambiMovie search(String movieTitle) {
                ...
                SearchMovieResponse response = restClient.get()
                                .uri(uriBase + "/search/movie?query={movieTitle}&include_adult=false&language=en-US&page=1",
                                                movieTitle)
                                .accept(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + configuration.tmdb_api_key())
                                .accept(MediaType.APPLICATION_JSON)
                ...
                return new RambiMovie(first.title(), first.overview(),
        ...
        public void afterPropertiesSet() throws Exception {
                logger.info("TMDB KEY {}", this.configuration.tmdb_api_key());
        }
